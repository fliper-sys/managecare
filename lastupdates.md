...
•	Procurement and Procurement history should be joined
•	New sale should be removed and it dose thesame thing with quick sale .Aside having the invoice feature untop. So it should be taken out
•	The workers restriction feature still doesn't work . Both when creating a worker or when adding a new worker,  it still does not work