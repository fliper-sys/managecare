...
/**
 * Middleware: requires the caller to be the OWNER of the business.
 * Must run after requireBusinessMembership (needs req.businessMembership).
 */
function requireBusinessOwner(req, res, next) {
  if (!req.businessMembership?.is_owner) {
