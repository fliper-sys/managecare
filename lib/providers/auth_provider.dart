...
class AuthProvider with ChangeNotifier {
  ...
  @visibleForTesting
  static bool shouldUseCachedUserDuringStartup({
    required bool autoLoginEnabled,
    required UserModel? cachedUser,
    required String? firebaseUserId,
  }) {
    if (!autoLoginEnabled || cachedUser == null) {
      return false;
    }

    return firebaseUserId == null || firebaseUserId.isEmpty;
  }
